...
def train(data_loader, model, optimizer, args, writer):
    for images, _ in tqdm(data_loader, ncols=100, colour='yellow'):
...
def main(args):
    ...
    elif args.dataset in ['celeba', 'luna16']:
        transform = transforms.Compose([
            transforms.RandomResizedCrop(128),
            transforms.ToTensor(),
            transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))
...
if __name__ == '__main__':
    ...
    # General
    parser.add_argument('--data-folder', type=str, default='dataset/luna16/all',
        help='name of the data folder')
    parser.add_argument('--dataset', type=str, default='luna16',
    ...
    parser.add_argument('--num-epochs', type=int, default=500, help='number of epochs (default: 100)')
    parser.add_argument('--lr', type=float, default=2e-4, help='learning rate for Adam optimizer (default: 2e-4)')
    parser.add_argument('--beta', type=float, default=0.25, help='contribution of commitment loss, between 0.1 and 2.0 (default: 1.0)')

    # Miscellaneous
    parser.add_argument('--output-folder', type=str, default='vqvae', help='name of the output folder (default: vqvae)')
    parser.add_argument('--num-workers', type=int, default=mp.cpu_count() - 1, help='number of workers for trajectories sampling (default: {0})'.format(mp.cpu_count() - 1))
