...
def check_anchors(dataset, model, thr=4.0, imgsz=640):
    ...
    def metric(k):  # compute metric
        ...
        return bpr, aat
    # print("previous anchor ",m.anchors)
    stride = m.stride.to(m.anchors.device).view(-1, 1, 1)  # model strides
    anchors = m.anchors.clone() * stride  # current anchors
    # current anchors tensor([[[ 10.,  13.],
    #      [ 16.,  30.],
    #      [ 33.,  23.]],
...
#         kmean_anchors anchors [[     2.2515      2.2484]
#  [     2.7281      3.2107]
#  [     3.2993      3.5872]
#  [     4.0029      3.3655]
#  [      2.735      5.6413]
...
# m.anchors anchors tensor([[[0.28144, 0.28105],
#          [0.34102, 0.40133],
#          [0.41242, 0.44839]],
